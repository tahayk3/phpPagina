...
<body>
    <div class="container">
        <form action = "../accionesMedicamentos/db_editar.php" method="POST">
            <input type="Hidden" name ="id_medicamento" value="<?php echo $fila['id_medicamento']?>">

            <div class="form-group">
                <label>Nombre</label>
                <input name="nombre_medicamento" value="<?php echo $fila['nombre_medicamento'] ?>" type="text" class="form-control"  placeholder="Nombre del medicamento">
            </div>

            <div class="form-group">
                <label>Precio</label>
                <input name="precio" value="<?php echo $fila['precio'] ?>"  type="number" class="form-control"  placeholder="Descripción del medicamento" >
            </div>
